#На то что-бы понять как работает эта хреновина я потратил целый день, а потом закодил за 15 минут странно и обидно. Но приятно, что я смог закодить что-то сложнее вижнера и цезаря.
